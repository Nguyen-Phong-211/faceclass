"""
Django settings for faceclass project.
...
SECRET_KEY = 'django-insecure-=owa-+_1b)&(x2is4=(k&kqm^43oi+r619mt4-l7s*^4#o9$bw'
...
EMAIL_HOST_PASSWORD = 'npmw gipe fnut vqay'   
