...
class Account(AbstractBaseUser, PermissionsMixin):
    ...
    avatar_url = models.ImageField(upload_to='account_avatars/', blank=True, null=True)
    deleted_at = models.DateTimeField(null=True, blank=True)
    is_locked = models.CharField(max_length=1, default='0')
    reset_token = models.CharField(max_length=255, null=True, blank=True)
    is_verified_email = models.CharField(max_length=1, default='0')
